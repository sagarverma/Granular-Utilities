...
fin = open('Chandigarh.txt','r')
w = csv.writer(open('Chandigarh_map.txt','w'))
...
def download_images(dic):
    ...
    for lats_longs in dic.keys():
        ...
        urllib.urlretrieve (url, "../../datasets/Chandigarh_imgs/" + str(i).zfill(10) + ".jpg")
...
for dic_slice in chunks(dic, THREADS):
    #print dic_slice
