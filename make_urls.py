...
for i in range(THREADS):
    ...
    scrapper_thread = threading.Thread(target = fast_url_scraper, args = (this_lat, this_long, org_dist_east, org_dist_south / THREADS, 'Chandigarh/Chandigarh_urls' + str(i + 1) + '.txt'))
