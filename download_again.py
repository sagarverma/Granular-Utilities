...
r1 = csv.reader(open('Chandigarh_map.txt','r'))
fin1 = open('valid','r')

fin2 = open('Chandigarh.txt','r')
...
for line in fin1.readlines():
    img_name = re.search('imgs/(.*?).jpg', line, re.IGNORECASE).group(1)
...
for invalid in invalids:
    url = invalid[1]
    i = invalid[0]
    urllib.urlretrieve (url, "../../datasets/Chandigarh_imgs/" + i)